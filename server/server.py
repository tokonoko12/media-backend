...
class Server:
    ...
    def registerRoutes(self):
        ...
        self.app.add_url_rule("/details/movies/<tmdb_id>", "get_movie_detail", lambda tmdb_id: get_movie_detail(tmdb_id, self.server_base_url), methods=["GET"])
        self.app.add_url_rule("/details/series/<tmdb_id>", "get_series_detail", get_series_detail, methods=["GET"])
        self.app.add_url_rule("/details/series/<tmdb_id>/season/<season_number>", "get_season_details", lambda tmdb_id, season_number: get_season_details(tmdb_id, season_number, self.server_base_url), methods=["GET"])
